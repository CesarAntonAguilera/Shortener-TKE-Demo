...
o Controllers: HTTP endpoints and request handling
o Services: Business logic (URL validation, code generation, idempotency)
o Repositories: In-memory data storage
o DTOs: Immutable data contracts
...
* CORS
Enabled to allow requests from http://localhost:4200.
...
o URL validation
o Short code generation
o Collision handling
o Idempotency (same URL ? same code)
...
o 400 Bad Request for invalid URLs
o 500 Internal Server Error for unexpected errors
* Redirection Handling
Accessing GET /{shortCode} returns an HTTP 302 Redirect to the original URL.
...
Another note: Redirection response doesn’t work in Swagger
Frontend
cd Frontend
npm install
ng serve
